  ...
  Widget _buildStudioAutocomplete(Color color) {
    return Autocomplete<String>(
      ...
      onSelected: (String selection) =>
          setState(() => _studioInput = selection),
      fieldViewBuilder:
          (context, textEditingController, focusNode, onFieldSubmitted) {
            ...
            return TextField(
              ...
              focusNode: focusNode,
              onChanged: (val) => _studioInput = val,
            ...
            Row(
              children: [
                ...
                TextButton.icon(
                  ...
                  style: TextButton.styleFrom(
                    foregroundColor: _isTagEditMode ? Colors.grey[600] : color,
                    padding: const EdgeInsets.symmetric(horizontal: 12),
                    shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(20),
                    ),
              ...
              Hero(
                ...
                child: Material(
                  ...
                  child: Container(
                    ...
                    child: InkWell(
                      onTap: _coverUrl == null ? _pickLocalImage : _previewCover,
                      borderRadius: BorderRadius.circular(24),
                      child: Container(
                        width: 100,
                        height: 140,
                  ...
                  children: [
                    TextField(
                      ...
                      decoration: InputDecoration(
                        hintText: _subjectType == 'anime' ? '番剧名称' : '漫画/书籍名称',
                        hintStyle: TextStyle(
                          ...
                          child: SliderTheme(
                            ...
                            child: Slider(
                              ...
                              onChanged: (val) {
                                setState(() {
                                  _rating = val;
                                  _ratingController.text = val.toStringAsFixed(
                                    1,
                                  );
                                });
                              },
  ...
  Widget _buildReminderDaySelector(Color color) {
    ...
    return InkWell(
      onTap: () async {
        ...
        if (selectedDay != null) {
          setState(() => _reminderDay = selectedDay);
        }
      },
      child: Container(
        ...
        child: Row(
          ...
          children: [
            Icon(
              Icons.calendar_today_outlined,
              size: 14,
              color: _broadcastDay != null ? color : Colors.grey[600],
            ),
            const SizedBox(width: 4),
            Text(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: _broadcastTime != null
              ? color.withValues(alpha: 0.1)
              : (_broadcastDay == null ? Colors.grey[200] : Colors.grey[50]),
          borderRadius: BorderRadius.circular(8),
          border: Border.all(
            color: _broadcastTime != null
                ? color.withValues(alpha: 0.3)
